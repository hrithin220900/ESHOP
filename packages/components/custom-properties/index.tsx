              ...
              <div className="mt-2">
                ...
                <div className="flex flex-col gap-3">
                  {properties.map((property, index) => (
                    ...
                    >
                      ...
                      <div className="flex items-center mt-2 gap-2">
                        <input
                          type="text"
                          className="outline-none border border-gray-700 bg-gray-800 p-2 rounded-md text-white w-full"
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <button
                      onClick={addProperty}
                      className="px-3 py-2 flex items-center gap-2 text-blue-500 hover:text-blue-600"
                    >
                      <Plus size={16} /> Add
                    </button>
                  </div>
